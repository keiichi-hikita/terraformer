...
type NetworkStaticRouteGenerator struct {
	ECLService
}

// createResources iterate on all ecl_network_static_route_v2
func (g *NetworkStaticRouteGenerator) createResources(list *pagination.Pager) []terraform_utils.Resource {
	resources := []terraform_utils.Resource{}

	list.EachPage(func(page pagination.Page) (bool, error) {
		srs, err := static_routes.ExtractStaticRoutes(page)
		if err != nil {
			return false, err
		}
...
func (g *NetworkStaticRouteGenerator) InitResources() error {
	...
	list := static_routes.List(client, static_routes.ListOpts{})
